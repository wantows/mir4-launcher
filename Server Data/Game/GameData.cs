...
namespace Server_Console.Server_Data
{
    public partial class GameData : Form
    {
        ...
        {
            string logDirectoryPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "GameServer", "Data");
        ...
        private void DataListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                string selectedFilePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "GameServer", "Data", DataListBox.SelectedItem.ToString());
